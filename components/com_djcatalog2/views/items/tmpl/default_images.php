...
<div class="djc_images">
	...
	<?php } ?>
	<?php for($i = 0; $i < count($this->item->images); $i++) { ?>
		<a id="djc_lb_<?php echo $i; ?>" rel="lightbox-djcategory" title="<?php echo $this->item->images[$i]->caption; ?>" href="<?php echo $this->item->images[$i]->fullscreen; ?>" style="display: none;"></a>
	<?php } ?>
</div>