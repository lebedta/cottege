...
class DjClassifiedsViewFields extends JView
{
	...
	protected function addToolbar()
	{
		...
		JSubMenuHelper::addEntry(JText::_('COM_DJCLASSIFIEDS_FIELDS'), 'index.php?option=com_djclassifieds&view=fields', true);
