    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th width="35%">
					<?php echo JHtml::_('grid.sort', JText::_('COM_DJCLASSIFIEDS_DAYS'), 'f.days', $listDirn, $listOrder); ?>
                </th>
                <th width="35%">
					<?php echo JHtml::_('grid.sort', JText::_('COM_DJCLASSIFIEDS_PRICE'), 'f.price', $listDirn, $listOrder); ?>
                </th>                    
                <th width="10%">
