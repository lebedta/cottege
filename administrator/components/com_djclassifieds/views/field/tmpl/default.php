...
?>
		<form action="index.php" method="post" name="adminForm" id="adminForm" enctype='multipart/form-data'>
			...
			<legend><?php echo JText::_('Details'); ?></legend>
	            ...
	            <tr id="field_values_box" <?php if($this->field->type=='inputbox' || $this->field->type=='textarea'){ echo 'style="display:none;"';}?>>
	                <td width="200" align="right" class="key">
	            ...
	            <tr>
	                ...
	                <td>
	                   <input class="text_area" type="text" name="params" id="params" size="100" maxlength="250" value='<?php echo $this->field->params; ?>' />
	                </td>
	            </tr>	            
				<tr>
					<td width="200" align="right" class="key">
