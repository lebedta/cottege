...
?>
<form action="index.php?option=com_djclassifieds&task=categories" method="post" name="adminForm">
            ...
            <td>
            	<?php 
          			if(strlen($c->description) > 130){
					   echo mb_substr($c->description, 0, 130,'utf-8').' ...';						
					}else{
						echo $c->description;
					}	
            	?>
				...
				<td class="order">
					...
					?>
								...
								<span><?php echo $this->pagination->orderDownIcon($i, $this->countCategories, ($c->parent_id == @$this->categories[$i+1]->parent_id), 'categories.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
