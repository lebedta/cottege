...
class DJClassifiedsViewPromotion extends JView
{ 

	function display($tpl = null)
	{				
	    //$model =& $this->getModel();
	    $this->promotion = $this->get('Promotion');
	...
	protected function addToolbar()
	{
		...
		$isNew		= ($this->promotion->id == 0);

		$text = $isNew ? JText::_( 'COM_DJCLASSIFIEDS_NEW' ) : JText::_( 'COM_DJCLASSIFIEDS_EDIT' );
		JToolBarHelper::title(   JText::_( 'COM_DJCLASSIFIEDS_PROMOTION' ).': <small><small>[ ' . $text.' ]</small></small>', 'generic.png' );
