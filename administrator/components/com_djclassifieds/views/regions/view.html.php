...
class DjClassifiedsViewRegions extends JView
{
	...
	protected function addToolbar()
	{
		...
		JSubMenuHelper::addEntry(JText::_('COM_DJCLASSIFIEDS_LOCALIZATION'), 'index.php?option=com_djclassifieds&view=regions', true);
