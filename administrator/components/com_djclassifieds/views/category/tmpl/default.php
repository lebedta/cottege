...
?>
		<form action="index.php" method="post" name="adminForm" id="adminForm" enctype='multipart/form-data'>
				...
				<tr>
					...
					<td>
						<?php
							...
							//DJClassifiedsCategory::getSubCat(1);
							//DJClassifiedsCategory::getCatAll();
	            ...
	            <tr>
            	    ...
            	    <td>
                	    <select name="autopublish">
                	    	<option value="0" <?php if($this->category->autopublish=='0'){echo 'selected';}?> ><?php echo JText::_('Global');?></option>
							<option value="1" <?php if($this->category->autopublish=='1'){echo 'selected';}?> ><?php echo JText::_('Yes');?></option>
							<option value="2" <?php if($this->category->autopublish=='2'){echo 'selected';}?> ><?php echo JText::_('No');?></option>
                	    </select>                  
	                </td>
    	        </tr>				
	            <tr>
            ...
            <tr>
                ...
                <td>
                	<input type="hidden" name="icon_url" id="icon_url" value="<?php echo $this->category->icon_url ?>" />
                    <?php
							if(!$image = $this->category->icon_url){
								...
								$sciezka .= $this->category->icon_url;
